...
public class ProceduralGenerator : MonoBehaviour
{
    ...
    private void ProceduralGenerate()
    {
        ...
        while (roomsListAus.Count > 0) 
        {
            ...
            int pointedIndex = Random.Range(0, roomsSelected.Count);
            Room pointedRoom = roomsSelected[pointedIndex];
            bool oneRoom = false;
            x = pointedRoom.x;
            y = pointedRoom.y;
            ...
            {
                roomsSelected.RemoveAt(pointedIndex);
                continue;
            }
    ...
    private int FindTheRoom(Location loc, int roomsListCount)
    {
        ...
        int selectedIndex = Random.Range(0, possibleRooms.Count);
        return possibleRooms[selectedIndex];
    }
